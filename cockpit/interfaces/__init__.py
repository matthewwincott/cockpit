...
Historically, this subpackage was limited to provide and interface for
when multiple handlers needed to be aggregated together to perform
complex tasks.  But as data and logic has been extracted from the GUI
