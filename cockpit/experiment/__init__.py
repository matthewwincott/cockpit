...
experiments is done in the ``cockpit.gui.dialogs.experiment`` package,
but that code ultimately just creates an ``Experiment`` subclass
(e.g. ``ZStackExperiment``) with appropriate parameters.
